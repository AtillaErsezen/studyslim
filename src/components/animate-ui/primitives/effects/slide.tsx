...
// Import AnimationDefinition type
...
function Slide({
  ...
  const hidden: Variant = {
    ...
    // Add opacity to hidden state for a smoother entry
    opacity: 0, 
  };
  const visible: Variant = { 
    [axis]: 0,
    // Add opacity to visible state
    opacity: 1,
  };
  ...
  return (
    <Component
      ...
      // Pass the prop down to the motion component
...
function Slides({
  ...
  delay = 0,
  holdDelay = 0,
  // onAnimationComplete will be passed through ...props here
  ...props
}: SlideListProps) {
